    ...
    <div class="container col-sm-12">
        ...
        <div class="collapse navbar-collapse" id="top-navbar-1">
            <ul class="nav navbar-nav navbar-right">
                ...
                <li><?= $this->Html->link('Upload Document',['controller' => 'users', 'action'=>'upload']) ?></li>
                <li class="dropdown" style="display:none">
                    <a href="#" class="dropdown-toggle" data-toggle="dropdown" data-hover="dropdown" data-delay="1000">
                        <?= $this->Html->tag('span','Check Document') ?>
                    </a>
                    <ul class="dropdown-menu dropdown-menu-left" role="menu">
                        <li><?= $this->Html->link('Upload Document',['controller' => 'users', 'action'=>'upload']) ?></li>
                        <li><?= $this->Html->link('Download Document',['controller' => 'users', 'action'=>'listfile']) ?></li>
                        <li><?= $this->Html->link('Manage My Account',['controller' => 'users', 'action'=>'manage']) ?></li>
                    </ul>
                </li>
            </ul>
        </div>
