    ...
    <div class="container col-sm-12">
        ...
        <div class="collapse navbar-collapse" id="top-navbar-1">
            <ul class="nav navbar-nav navbar-right">
                <li>
                    <?= $this->Html->link(' Home',['controller' => 'pages', 'action' => 'homepage'], ['class'=>"fa fa-home" ]) ?>
                </li>
                <li>
                    <?= $this->Html->link(' Services',['controller' => 'pages', 'action' => 'visas'], ['class'=>"fa fa-tasks" ]) ?>
                </li>
                <li>
                    <?= $this->Html->link(' About Us',['controller' => 'pages', 'action'=>'aboutus'], ['class'=>"fa fa-user"]) ?>
                </li>
                <li>
                    <?= $this->Html->link(' Contact Us',['controller' => 'pages', 'action'=>'contactus'], ['class'=>"fa fa-envelope"]) ?>
                </li>
                <li>
                    <?= $this->Html->link(' Feedback',['controller' => 'pages', 'action'=>'feedbacks'], ['class'=>"fa fa-paperclip"]) ?>
                </li>
                <li class="dropdown">
                    <a href="#" class="dropdown-toggle" data-toggle="dropdown" data-hover="dropdown" data-delay="1000">
                        <?= $this->Html->tag('span',' Appointment',array('class'=>"fa fa-table")) ?>
                    </a>
        ...
        <div class="row">
            <div class="col-sm-6 footer-box wow fadeInUp">
                ...
                <div class="footer-box-text">
                    <a href="https://www.mara.gov.au/becoming-an-agent/professional-standards-and-obligations/code-of-conduct" target="_blank">Click here to see Code of Conduct</a>
                </div>
            </div>
