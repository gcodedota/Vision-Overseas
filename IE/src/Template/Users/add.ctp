...
<body>
<div>
    <h3 style="position: absolute; left: 200px; display: inline-block">Create New Account</h3>
            ...
            <div class="row">
                ...
                <div class="col-md-6 input_form" id="customer" style="display: none">
                    <div class="work wow fadeInUp" style="height: 330px">
                        ...
                        <p>
                            ...
                            echo $this->Form->input(
                                'dropbox',array('type'=>'select','options'=> array('yes' => 'yes', 'no' => 'no')));
                            ?>
                        </p>
                    </div>
                </div>
                <div class="col-md-6 input_form" id="admin" style="display: none">
                    <div class="work wow fadeInUp" style="height: 330px">
                        ...
                        <?= $this->Form->create($admin,['novalidate'=>true]) ?>
                        <fieldset>
                            <?php
